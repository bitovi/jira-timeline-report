        ...
        */
        ...
        get cvsIssuesPromise() {
            ...
            if (this.loginComponent.isLoggedIn === false) {
                ...
                if ((_a = this.derivedIssuesRequestData) === null || _a === void 0 ? void 0 : _a.issuesPromise) {
        ...
        derivedIssues: {
            async: function (resolve) {
                var _a;
                (_a = this.derivedIssuesRequestData) === null || _a === void 0 ? void 0 : _a.issuesPromise.then(resolve);
            }
        }
    };
