...
function getSprintsMapsFromIssues(issues) {
    ...
    for (var _i = 0, issues_1 = issues; _i < issues_1.length; _i++) {
        ...
        for (var _a = 0, _b = (issue_1.Sprint || []); _a < _b.length; _a++) {
            var sprint = _b[_a];
...
function getVersionsFromIssues(issues) {
    ...
    for (var _i = 0, issues_2 = issues; _i < issues_2.length; _i++) {
        ...
        for (var _a = 0, _b = (issue_2["Fix versions"] || []); _a < _b.length; _a++) {
            var version = _b[_a];
...
export function issue(issue, rollbackTime, data) {
    ...
    var copy = __assign({}, issue);
    for (var _i = 0, _a = issue.changelog; _i < _a.length; _i++) {
        var _b = _a[_i], items = _b.items, created = _b.created;
