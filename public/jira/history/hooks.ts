...
export const useHistoryStateValue: (
  key: string,
) => [string | undefined, (val: string | undefined) => void] = (key) => {
...
export const useHistoryState: () => [
  ...
  (val: Record<string, string | null>) => void,
] = () => {
...
export const useHistoryParams: () => [string, (val: string) => void] = () => {
...
export const useHistoryValueCallback: (
  key: string,
  callback: (newVal: string | undefined) => void,
) => void = (key, callback) => {
  useEffect(() => {
...
export const useHistoryCallback: (callback: (newVal: Record<string, string>) => void) => void = (
  callback,
) => {
  useEffect(() => {
