...
test('rollupWorkTypeDates all with dates', ()=> {
    ...
    const result = rollupWorkTypeDates([
        [
            {key: "o-1", parentKey: null, derivedTiming: {start: _2000, due: _2007}, derivedStatus: {workType: "dev"}, type: "outcome"}
        ],
        [
            {key: "m-2", parentKey: "o-1", derivedTiming: {start: _2001, due: _2004}, derivedStatus: {workType: "dev"}, type: "milestone"},
            {key: "m-3", parentKey: "o-1", derivedTiming: {start: _2003, due: _2007}, derivedStatus: {workType: "qa"}, type: "milestone"}
        ],
        [
            {key: "i-4", parentKey: "m-2", derivedTiming: {start: _2000, due: _2002}, derivedStatus: {workType: "design"}, type: "initiative"},
            {key: "i-5", parentKey: "m-2", derivedTiming: {start: _2002, due: _2004}, derivedStatus: {workType: "design"}, type: "initiative"},
            {key: "i-6", parentKey: "m-3", derivedTiming: {start: _2003, due: _2004}, derivedStatus: {workType: "qa"}, type: "initiative"},
            {key: "i-7", parentKey: "m-3", derivedTiming: {start: _2004, due: _2007}, derivedStatus: {workType: "qa"}, type: "initiative"}
        ]
    ].reverse());
    ...
    expect(combinedRollupData[2][0]).toStrictEqual({
        design: {
            issueKeys: ["i-4"], start: _2000,  due: _2002
        }
    });
    ...
    expect(combinedRollupData[1][0]).toStrictEqual({
        design: {
            issueKeys: ["i-4","i-5"], start: _2000,  due: _2004
        },
        dev: {
            issueKeys: ["m-2"], start: _2001, due: _2004
        }
    });
...
test('rollupWorkTypeDates only leaf dates', ()=> {
    ...
    const result = rollupWorkTypeDates([
        [
            {key: "o-1", parentKey: null, derivedTiming: {}, derivedStatus: {workType: "dev"}, type: "outcome"}
        ],
        [
            {key: "m-2", parentKey: "o-1", derivedTiming: {}, derivedStatus: {workType: "dev"}, type: "milestone"},
            {key: "m-3", parentKey: "o-1", derivedTiming: {}, derivedStatus: {workType: "qa"}, type: "milestone"}
        ],
        [
            {key: "i-4", parentKey: "m-2", derivedTiming: {start: _2000, due: _2002}, derivedStatus: {workType: "design"}, type: "initiative"},
            {key: "i-5", parentKey: "m-2", derivedTiming: {start: _2002, due: _2004}, derivedStatus: {workType: "design"}, type: "initiative"},
    ...
    expect(combinedRollupData[0][0]).toStrictEqual({
        ...
        qa: {
            issueKeys: ["i-6","i-7"], start: _2003,  due: _2007
        }
    });
