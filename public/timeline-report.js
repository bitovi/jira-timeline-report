...
export class TimelineReport extends StacheElement {
  static view = `
    {{#if(showingConfiguration)}}
        ...
        ></timeline-configuration>
    {{/if}}
    <div class="fullish-vh pt-4 pl-4 pr-4 relative grow flex flex-1 flex-col h-full" on:click="this.goBack()">
      ...
      {{# and(this.routeData.derivedIssuesRequestData.issuesPromise.isResolved, this.primaryIssuesOrReleases.length) }}
        <div class="my-2 border-box block overflow-y-auto color-bg-white flex-1">
