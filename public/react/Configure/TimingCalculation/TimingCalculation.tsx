...
export const TimingCalculation = () => {
    ...
    <>
        ...
        <div className="flex flex-col gap-2 my-2">
            ...
            {selectableTimingLevels.map((timingLevel, index) => (
              <div className={`flex flex-row ${paddingClass(index)}`}>
                ...
                <div className="flex flex-col">
                  ...
                  {timingLevel.calculations.map(calculation => (
                      <option selected={calculation.selected} value={calculation.calculation}>{calculation.name}</option>
                  ))}
                  </select>
