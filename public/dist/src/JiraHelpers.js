...
var JiraHelpers = /** @class */ (function () {
    function JiraHelpers(_a, requestHelper, fetchJSON) {
        ...
        this.fetchJiraSprint = function (sprintId) {
            return requestHelper("/agile/1.0/sprint/".concat(sprintId));
        };
    ...
    JiraHelpers.prototype.saveInformationToLocalStorage = function (parameters) {
    ...
    JiraHelpers.prototype.clearAuthFromLocalStorage = function () {
        window.localStorage.removeItem("accessToken");
        window.localStorage.removeItem("refreshToken");
        window.localStorage.removeItem("expiryTimestamp");
    };
    JiraHelpers.prototype.fieldsToEditBody = function (obj, fieldMapping) {
    ...
    JiraHelpers.prototype.mapNamesToIds = function (obj, fields) {
        var mapped = {};
        for (var prop in obj) {
            //if(prop === "Story points") {
            // 10016 -> story point estimate
    ...
    JiraHelpers.prototype.fetchFromLocalStorage = function (key) {
        return window.localStorage.getItem(key);
    };
    JiraHelpers.prototype.fetchAuthorizationCode = function () {
    ...
    JiraHelpers.prototype.refreshAccessToken = function (accessCode) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    JiraHelpers.prototype.fetchAccessTokenWithAuthCode = function (authCode) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    JiraHelpers.prototype.fetchJiraIssuesWithJQLWithNamedFields = function (params) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    JiraHelpers.prototype.fetchAllJiraIssuesWithJQL = function (params) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    JiraHelpers.prototype.fetchAllJiraIssuesWithJQLUsingNamedFields = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var fields, newParams, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    JiraHelpers.prototype.isChangelogComplete = function (changelog) {
        return changelog.histories.length === changelog.total;
    };
    JiraHelpers.prototype.fetchRemainingChangelogsForIssues = function (issues, progress) {
        var _this = this;
    ...
    JiraHelpers.prototype.fetchRemainingChangelogsForIssue = function (issueIdOrKey, mostRecentChangeLog) {
        ...
        for (var i = 0; i < total - maxResults; i += maxResults) {
            requests.push(this.fetchJiraChangelog(issueIdOrKey, {
    ...
    JiraHelpers.prototype.fetchAllJiraIssuesWithJQLAndFetchAllChangelog = function (params, progress) {
        var _this = this;
        ...
        var firstRequest = this.fetchJiraIssuesWithJQL(__assign({ maxResults: 100, expand: ["changelog"] }, apiParams));
    ...
    JiraHelpers.prototype.fetchAllJiraIssuesWithJQLAndFetchAllChangelogUsingNamedFields = function (params, progress) {
        return __awaiter(this, void 0, void 0, function () {
            var fields, newParams, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    JiraHelpers.prototype.fetchAllJiraIssuesAndDeepChildrenWithJQLAndFetchAllChangelogUsingNamedFields = function (params, progress) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    JiraHelpers.prototype.fetchChildrenResponses = function (params, parentIssues, progress) {
        var _this = this;
    ...
    JiraHelpers.prototype.fetchDeepChildren = function (params, sourceParentIssues, progress) {
        return __awaiter(this, void 0, void 0, function () {
            var batchedFirstResponses, getChildren, batchedIssueRequests;
            var _this = this;
            return __generator(this, function (_a) {
                batchedFirstResponses = this.fetchChildrenResponses(params, sourceParentIssues, progress);
                ...
                return [2 /*return*/, Promise.all(batchedIssueRequests).then(function (allChildren) {
                        return allChildren.flat();
                    })];
            });
        });
    };
    JiraHelpers.prototype.getAccessToken = function () {
        return __awaiter(this, void 0, void 0, function () {
            var refreshToken;
            return __generator(this, function (_a) {
    ...
    JiraHelpers.prototype.hasAccessToken = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, !!this.fetchFromLocalStorage("accessToken")];
            });
    ...
    JiraHelpers.prototype.hasValidAccessToken = function () {
        var accessToken = this.fetchFromLocalStorage("accessToken");
        var expiryTimestamp = Number(this.fetchFromLocalStorage("expiryTimestamp"));
