...
describe("Lookup", () => {
  ...
  test("looks up the team fields", () => {
    ...
    expect(getFieldFor({ team: "bitovi", issueLevel: "1", field: "startDateField" })).toBe(
      "Start Date"
    );
    expect(getFieldFor({ team: "bitovi", issueLevel: "1", field: "dueDateField" })).toBe(
      "Due Date"
    );
    expect(getFieldFor({ team: "bitovi", issueLevel: "1", field: "estimateField" })).toBe(
      "Story Points"
    );
    expect(getFieldFor({ team: "bitovi", issueLevel: "1", field: "confidenceField" })).toBe(
      "Confidence"
    );
  });
