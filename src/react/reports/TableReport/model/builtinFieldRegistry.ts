...
export const BUILTIN_CONCEPTS: readonly BuiltinConcept[] = [
  ...
  },
  {
    ...
    facets: [
      ...
      {
        sourceId: 'builtin:parent:summary',
        label: 'Parent Summary',
        requires: [],
        get: (issue) => parent(issue)?.summary,
      },
  ...
  },
  {
    ...
    claims: ['Sprint'],
    facets: [
      { sourceId: 'builtin:sprint:names', label: 'Sprint', requires: [], get: (issue) => joinNames(issue.sprints) },
    ],
  },
  {
    concept: 'release',
    claims: ['Fix versions'],
    facets: [
      { sourceId: 'builtin:release:names', label: 'Release', requires: [], get: (issue) => joinNames(issue.releases) },
    ],
  },
  {
    concept: 'labels',
  ...
  },
  {
    ...
    facets: [
      {
        sourceId: 'builtin:created:date',
        label: 'Created',
        requires: [],
        get: (issue) => issue.fields?.['Created'],
        schemaType: 'date',
      },
    ],
  },
...
export const REPORT_FIELD_FACETS: readonly BuiltinFacet[] = [
  {
    sourceId: 'report:startDate',
    label: 'Start Date',
    requires: [],
    get: (issue) => issue.startDate,
    schemaType: 'date',
  },
  { sourceId: 'report:dueDate', label: 'Due Date', requires: [], get: (issue) => issue.dueDate, schemaType: 'date' },
  {
    sourceId: 'report:storyPoints',
    label: 'Story Points',
    requires: [],
    get: (issue) => issue.storyPoints,
    schemaType: 'number',
  },
  {
    sourceId: 'report:storyPointsMedian',
    label: 'Story Point Median',
    requires: [],
    get: (issue) => issue.storyPointsMedian,
    schemaType: 'number',
  },
  {
    sourceId: 'report:confidence',
    label: 'Confidence',
    requires: [],
    get: (issue) => issue.confidence,
    schemaType: 'number',
  },
];
