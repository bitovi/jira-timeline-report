...
export const IssueSimulationRow: React.FC<{
    ...
    <div className="pl-5 self-center pr-2 truncate max-w-sm"
    ...
    <div 
        ...
        onMouseEnter={()=>{
          console.log({issue, ...getDatesFromSimulationIssue(issue, selectedStartDate, gridData)});
        }}
        style={
        ...
        <div className="relative block py-0.5 z-50">
          {
            ...
            <>
            {/* The Little Line */}
            <div className="absolute bg-gradient-to-r from-blue-200 to-green-200 from-85% to-95% h-1 top-2.5 border-box"
                  style={{
        ...
        {showDetails && <IssueSimulationDays 
          gridNumberOfDays={gridData.gridNumberOfDays}
          issue={issue}
          startOrDue="due"
          selectedStartDate={selectedStartDate}
...
export function getDatesFromSimulationIssue(
  ...
  const rangeStartDate = getUTCEndDateFromStartDateAndBusinessDays(startDate, issue.startDayBottom);
  ...
  return {
    ...
    startDateWithTimeEnoughToFinish: getUTCEndDateFromStartDateAndBusinessDays(startDate, issue.startDateWithTimeEnoughToFinish),
