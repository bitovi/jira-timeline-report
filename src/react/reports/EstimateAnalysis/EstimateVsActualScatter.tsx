  ...
  export function EpicEstimatesScatter({ teamTimings, team, setTeam }: Props) {
    ...
    return (
        <ResponsiveContainer width="100%" height={600}>
            ...
            <CartesianGrid />
            <XAxis type="number" dataKey="computedActualTeamDaysOfWork" 
                name="Actual" scale="log" domain={[0.5, 'auto']}  ticks={[.3, 1, 3, 10, 30, 100]}
                label={{ value: "Actual Team Days", position: "insideBottom", offset: -10 }} />
            <YAxis type="number" dataKey="estimatedTeamDays" 
                name="Estimated" scale="log" domain={[0.5, 'auto']}  ticks={[.3, 1, 3, 10, 30, 100]} 
