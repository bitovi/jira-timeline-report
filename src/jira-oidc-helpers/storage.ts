...
export function saveInformationToLocalStorage(parameters: Record<string, string | number | string[]>) {
  const objectKeys = Object.keys(parameters) as Array<keyof FetchJiraIssuesParams>;
